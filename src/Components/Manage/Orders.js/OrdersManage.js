...
class OrdersManage extends Component {
    ...
    toggleOrder = (e) =>{
        if(e.target.id == this.state.order_id){
            this.setState({
                                    ...
                                    <div className='row'>
                                        <div className='col-md-9 text-left p-0'>
                                            ...
                                            <p className='pl-2 m-0'>
                                                order: <button id={order.order_id} onClick={this.toggleOrder} className='btn btn-light border-primary'>View</button>
                                            </p>
                                                ...
                                                <ul style={scrollspy} className="col-md-6 offset-md-3 scrollbar-ripe-malinka menu-result p-0 mb-0  border border-success">
                                                    {
                                                        ...
                                                        : <p className='text-center'>chưa đặt món ăn</p>
                                                    }
                                                </ul>
                                            :''}
                                            <p className='pl-2 m-0'>sum: {order.price}</p>
                                            {order.status == 0 ?
                                                <p className='pl-2 m-0'>status: <span className='bg-danger border rounded p-1'>Chưa thanh toán</span></p>
                                                : <p className='pl-2 m-0'>status: <span className='bg-success border rounded p-1'>Đã thanh toán</span></p>}
                                        </div>
