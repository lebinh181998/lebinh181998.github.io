...
class EditFood extends Component {
    ...
    EditFood = (e) =>{
        ...
        let {name, price, images, category_id, check} = this.state;
        ...
        if(category_id){
            ...
            getFood && getFood[0].category_id ? formData.append('category_id', getFood[0].category_id) : err_flag = false;
        }
    ...
    render() { 
        ...
        let {name, price,category_id, categories} = this.state;
        return (
            getFood ?
                        ...
                        <form onSubmit={this.EditFood} value='2' className="form-horizontal form-material p-2"
                            ...
                            <div className="col-md-9 p-0">
                                <select className="form-control form-control-line"
                                    onChange={this.dataFood}
                                    name="category_id" 
                                    value={category_id ? category_id : (getFood[0].category_id ? getFood[0].category_id : 'error')}>
